...
namespace gep
{
    ...
    {
    public:
		IModelLoader(const char* resourceId);
    ...
    public:
		...
		GEP_RESOURCELOADER_DEFAULT_FUNCTIONS(ModelDummyLoader, "Model");
    };
    ...
    public:
		...
		GEP_RESOURCELOADER_DEFAULT_FUNCTIONS(ModelFileLoader, "Model");
	};
    ...
    */
    ...
    enum class ModelType
    {
        ...
        Dummy,   ///< Only used for the dummy model.
        Debug,   ///< Used for stuff like physics debug rendering, etc.
        Regular, ///< Used for regular models.

        EnumCount ///< Used for various compile-time checks (for you safety!)
    };
    ...
    private:
        ...
        ModelType m_type; ///< Required by the constructor.
    ...
    public:
        ...
        */
        Model(ModelType type, ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
        ...
        */
        ...
        inline ModelType getType() const { return m_type; }
