...
GEP_UNITTEST_TEST(WeakPtr, WeakPtr)
{
    ...
    GEP_ASSERT(ptr1.get() == const_cast<const WeakPtr<WeakRefTest>&>(ptr1).get());
    GEP_ASSERT(ptr2.get() == const_cast<const WeakPtr<WeakRefTest>&>(ptr2).get());
    GEP_ASSERT(ptr3.get() == const_cast<const WeakPtr<WeakRefTest>&>(ptr3).get());
