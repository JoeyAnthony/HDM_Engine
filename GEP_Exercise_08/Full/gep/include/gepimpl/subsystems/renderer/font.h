...
namespace gep
{
    ...
    {
    public:
		IFontLoader(const char* resourceId);
    ...
    public:
		...
		GEP_RESOURCELOADER_DEFAULT_FUNCTIONS(FontFileLoader, "Font");
    };
    ...
    public:
		...
		GEP_RESOURCELOADER_DEFAULT_FUNCTIONS(Texture2DFromFontLoader, "Texture2D");
    };
